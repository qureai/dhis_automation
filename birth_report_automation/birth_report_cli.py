"""
Birth Report Automation CLI
Main entry point for running birth notification automation
...
from birth_report_automation import BirthReportAutomation
...
def resolve_org_unit_id(facility_name: str, org_units: dict) -> str:
    ...
    if not org_unit:
        ...
        logger.error(f"  Search example: Ghatere, Yandina, Tulagi")
        return None
...
async def run_automation(
    ...
    """Run birth notification automation with dynamic resolution"""
    ...
    try:
        ...
        logger.info("\n" + "=" * 60)
        logger.info("DHIS2 Birth Notification Automation")
        logger.info("=" * 60)
        ...
        async with BirthReportAutomation(
            base_url=base_url,
            username=username,
            password=password,
            headless=headless,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='DHIS2 Birth Notification Automation (Dynamic Program & Org Unit Resolution)',
...
Examples:
  ...
  python birth_report_cli.py --data my_birth_data.json
  ...
  python birth_report_cli.py --no-complete
...
Data File Format:
  {
    ...
    parser.add_argument(
        ...
        help='Path to birth data file with _meta section (default: sample_data.json)'
    )
